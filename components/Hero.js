    ...
    return (
      <div id="home-section" className="relative bg-cover bg-center h-screen flex items-center justify-center text-white"
        ...
        <div className="bg-blue-500 bg-opacity-75 p-10 rounded-md text-center">
          <h1 className="text-3xl md:text-4xl font-bold">บริษัท พี เค เอ็น คัสตอมส เซอร์วิส จำกัด</h1>
          <p className="text-lg mt-2">ผู้เชี่ยวชาญด้านบริการนำเข้า-ส่งออกครบวงจร</p>
          <form className="mt-4">
            <div className="flex">
